...
- [x] 1. Setup testing infrastructure dan shared type definitions
  - [x] 1.1 Install dan konfigurasi Vitest + fast-check + jsdom
  ...
  - [x] 1.2 Install dan konfigurasi Playwright untuk E2E tests
  ...
  - [x] 1.3 Buat shared TypeScript type definitions
...
- [ ] 4. Implementasi Utility Libraries (Validation, Sanitization, Rate Limiter, Cache)
  ...
  - [x] 4.5 Buat sliding window rate limiter (server-side)
