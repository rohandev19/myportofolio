...
export function GlobalErrorFallback({ error, resetErrorBoundary }: FallbackProps) {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#070B14] text-[#F8FAFC] p-4 text-center">
      <h2 className="text-2xl font-bold text-[#E2E8F0] mb-4">Something went wrong</h2>
      ...
      <button
        ...
        className="px-6 py-3 bg-[#E2E8F0] text-[#070B14] font-semibold rounded-lg hover:bg-[#94A3B8] transition-colors focus:outline-none focus:ring-2 focus:ring-[#94A3B8]"
      >
        Try again
      </button>
    </div>
